...
export default function Exercise() {
    ...
    function UpdateExercise(e) {
        ...
        if (params.id) {
            axios.put(`http://localhost:3333/exercise/${params.id}`, ExecriseData, { headers: { "Authorization": context.token } })
                .then((res) => { console.log(res.data) }).catch((err) => console.log(err))
        }
        else {
            axios.post(`http://localhost:3333/exercise`, ExecriseData, { headers: { "Authorization": context.token } })
                .then((res) => { console.log(res.data) }).catch((err) => console.log(err))
